  ...
  const services = [
    {
      ...
      icon: <Lottie className='w-70 h-70' animationData={web} loop={true} />,
    },
    {
      title: 'Mobile App Development',
      description: 'iOS and Android apps built with native or cross-platform technologies.',
      icon: <Lottie className='w-70 h-70' animationData={mbl} loop={true} />,
    },
    {
      title: 'UI/UX Design',
      description: 'Beautiful, intuitive interfaces that enhance user experience.',
      icon: <Lottie className='w-70 h-70' animationData={uuid} loop={true} />,
    },
    {
    ...
    },
    {
      ...
      icon: <Lottie className='w-70 h-70' animationData={ai} loop={true} />,
    },
    {
      title: 'Business Analytics',
      description: 'Data-driven insights to help you make better decisions.',
      icon: <Lottie className='w-70 h-70' animationData={business} loop={true} />,
    },
  ]

  return (
    <section id='devservices' className="py-16 ">
